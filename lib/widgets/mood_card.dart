...
import 'package:mental_health_tracker/screens/login.dart'; // Impor halaman LoginPage
        ...
        onTap: () async {
          ...
          if (item.name == "Tambah Mood") {
            ...
            final response = await request.logout(
              "http://10.0.2.2:8000/auth/logout/", // Ganti URL ini dengan URL server Django kamu
            );
